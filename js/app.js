...
$(document).ready(function() {
	...
	$.ajax('data/projectSitePoints.json', {async:false}).done(function(data) {
		projectSiteLayer = new app.Layer({ geoJson: data, leafletSettings: { pointToLayer: circleMarker(2) } });
	});
